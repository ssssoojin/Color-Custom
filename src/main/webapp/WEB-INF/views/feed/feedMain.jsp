...
<html lang="en" class="no-js">
	...
	<%@ include file="../includes/header.jsp"%>
		...
		<link rel="stylesheet" type="text/css" href="/resources/css/feedMaindemo.css" />
		<link rel="stylesheet" type="text/css" href="/resources/css/feedMaincomponent.css" />
	...
	<body>
		...
		<div class="view">
			...
			<header class="bp-header cf">
				<span>ColorCustomer <span class="bp-icon bp-icon-about" data-content="The Blueprints are a collection of basic and minimal website concepts, components, plugins and layouts with minimal style for easy adaption and usage, or simply for inspiration."></span></span>
				<h1>너만의 CC를 표현해봐~!</h1>
				<nav>
			...
			<section class="grid">
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/1.png" alt="Product 1" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/2.png" alt="Product 2" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/10.png" alt="Product 3" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/4.png" alt="Product 4" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/5.png" alt="Product 5" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/6.png" alt="Product 6" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/7.png" alt="Product 7" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/8.png" alt="Product 8" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/9.png" alt="Product 9" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/10.png" alt="Product 10" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/2.png" alt="Product 11" />
				...
				<div class="product">
					<div class="product__info">
						<img class="product__image" src="/resources/images/4.png" alt="Product 12" />
